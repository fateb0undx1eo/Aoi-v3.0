          ...
          <div className="thecat">
            ...
            >
              ...
              <g transform="translate(-121.80376,-101.90461)">
                {/* Cat Body */}
                <path
                  style={{ display: 'inline', fill: '#000000', stroke: 'none', strokeWidth: '0.264583' }}
                ...
                <path
                  id="path5"
                  style={{ display: 'inline', fill: '#000000', stroke: 'none', strokeWidth: '0.292536' }}
                ...
                <g id="g25" style={{ display: 'inline' }}>
                  <path
                    style={{ fill: 'none', stroke: '#000000', strokeWidth: '0.529167' }}
                ...
                <g id="lefteyelid" style={{ display: 'inline' }}>
                  <ellipse
                    style={{ fill: '#000000', stroke: 'none', strokeWidth: '0.529167' }}
                    id="path21"
                    cx="131.94429"
                    cy="114.29948"
                    rx="3.1571214"
                  ...
                  />
                  <path
                    style={{ fill: '#000000', stroke: '#ffffff', strokeWidth: '0.529167' }}
                ...
                <g id="eyesdown">
                  <ellipse
                    style={{ fill: '#ffffff', stroke: 'none', strokeWidth: '0.529167' }}
                    id="path26"
                    cx="139.12122"
                    cy="113.61373"
                    rx="1.8686198"
                  ...
                  />
                  <ellipse
                    style={{ fill: '#000000', stroke: 'none', strokeWidth: '0.597086' }}
                    id="ellipse25"
                    cx="112.24622"
                    cy="139.77037"
                    rx="1.0380507"
                  ...
                  />
                  <ellipse
                    style={{ fill: '#f9f9f9', stroke: 'none', strokeWidth: '0.184905' }}
                    id="ellipse26"
                    cx="112.37342"
                    cy="139.28929"
                    rx="0.32146212"
                ...
                <path
                  id="tail"
                  style={{ display: 'inline', fill: '#000000', stroke: 'none', strokeWidth: '0.529167' }}
          ...
          <div className="relative mx-auto max-w-7xl px-1 pb-10 pt-6 sm:px-0 lg:pt-8">
            <Reveal className="relative text-center">
              ...
              <div className="relative mt-7">
                <div className="absolute -top-32 left-0 w-40 sm:w-48 z-20 pointer-events-auto">
