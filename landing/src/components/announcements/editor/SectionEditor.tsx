...
import type { EditingComponentData, ComponentFoundBackupHook } from "./ComponentEditor";
import type { DraftFile } from "../types";
import type { APIContainerComponent, APIV2Section, APIButtonComponent, QueryData } from "../types";
          ...
          return (
            <div key={String(component.id ?? ci)} className="flex gap-2">
              ...
              <div className="flex flex-col mt-4 text-lg">
                ...
                >
                  <CoolIcon icon="Trash_Empty" className="leading-none" />
                </button>
                <button
                  type="button"
                  className={twJoin(
              ...
              <p className="my-auto text-sm font-medium cursor-default truncate">
                ...
                {t(
                  accessory.type === ComponentType.Button &&
                    (accessory as APIButtonComponent).style === ButtonStyle.Link
                    ? "linkButton"
                ...
                <IndividualComponentEditor
                  ...
                  onClick={() => {
                    ...
                    if (
                      ...
                      (button as any).flow = (button as any).flow ?? { actions: [] };
                    }
                    setEditingComponent(
                      getSetEditingComponentProps({
                        component: button,
