  ...
  return (
    <div style={{ position: "relative", display: "inline-block" }}>
      <button ref={btnRef} type="button" onClick={() => setOpen(!open)}
        ...
        style={{ padding: label ? "4px 10px" : 0, width: label ? "auto" : 36, height: 36, gap: 6, overflow: "visible", whiteSpace: "nowrap" }}>
        <img src={ICON_ADD_COMPONENT} alt="" style={{ width: label ? 18 : 24, height: label ? 18 : 24, display: "block" }} />
