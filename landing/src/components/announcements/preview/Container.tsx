import { ComponentType, type APIActionRowComponent, type APIComponentInMessageActionRow, type APISectionComponent } from "discord-api-types/v10";
import { twJoin } from "tailwind-merge";
import type { SetImageModalData, DraftFile, APITopLevelComponent, APIContainerComponent } from "../types";
...
export interface TopLevelComponentPreviewProps {
  component: APITopLevelComponent;
  files?: DraftFile[];
...
export const AutoTopLevelComponentPreview = (
  ...
  switch (component.type) {
    case ComponentType.ActionRow:
      return <PreviewActionRow component={component as APIActionRowComponent<APIComponentInMessageActionRow>} />;
    ...
    case ComponentType.Section:
      return <PreviewSection {...props} component={component as APISectionComponent} />;
      ...
      >
        {container.components.map((component, ci) => (
          <AutoTopLevelComponentPreview
            ...
            {...props}
            component={component as APITopLevelComponent}
          />
        ))}
      </div>
    </div>
