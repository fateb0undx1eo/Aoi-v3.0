...
export const Checkbox = (
  ...
  <div>
    <label className="flex items-center gap-2">
      <MuiCheckbox.Root
        className={(s: { checked: boolean; focused: boolean }) =>
          twJoin(
...
const BigConditionalBox: React.FC<{ check?: boolean; className?: string }> = ({
  ...
  <svg
    ...
    className={twJoin(
      "my-auto ltr:mr-2 rtl:ml-2 shrink-0",
      check
  ...
  >
    {check ? (
      <>
        ...
        <path d="M7 12l3 3 7-7" stroke="white" strokeWidth="2.5" fill="none" />
      </>
    ) : (
