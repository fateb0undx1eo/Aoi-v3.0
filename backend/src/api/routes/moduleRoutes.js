...
export function createModuleRoutes({ moduleService, configService, configCache, accessControlService, authService, roleColorRotationService, memeService, botLooksService, staffListService, dashboardOverviewService, profileStyleService }) {
  const router = Router();
