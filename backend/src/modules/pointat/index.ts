...
function cid(action: string, userId: string, ...extra: string[]): string {
...
function parseCid(customId: string): ParsedCid | null {
...
const POINTAT_SCHEMA = { type: 'object', properties: {} } as const;
